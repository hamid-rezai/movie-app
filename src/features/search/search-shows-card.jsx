...
const SearchShowsCard = ({
  ...
  return (
    <motion.div
      ...
      className='relative w-[250px] h-[300px] bg-movie-card rounded-lg overflow-hidden shadow-lg transition-transform duration-300 cursor-pointer mb-10 group'
      whileHover={{ scale: 1.05 }}>
      <img
        src={imageUrl}
        alt={name || "No Name Available"}
        className='w-full h-[300px] object-center'
      />

      {hasImage && (
        <div className='flex flex-col items-center justify-center absolute bottom-0  w-full h-[70px] bg-navBack bg-opacity-90 opacity-0 group-hover:opacity-90 transition duration-300'>
...
export default SearchShowsCard;
