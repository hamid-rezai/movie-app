...
<div className="group relative h-[300px] sm:h-[350px] xl:h-[500px] w-[300px] xl:w-[400px] [perspective:1000px]">
  <div
    className="absolute duration-1000 w-full h-full top-0 left-0 [transform-style:preserve-3d] group-hover:[transform:rotateX(180deg)]"
  >
    <div
